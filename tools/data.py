...
# 자치구별 법정동 — (dong_slug, 한글 동 베이스). 표기는 베이스+"동", 경로는 /seoul/<gu>/<slug>/
DONGS = {
    "gangnam-gu": [("yeoksam-dong", "역삼"), ("samseong-dong", "삼성"), ("cheongdam-dong", "청담"),
                   ("nonhyeon-dong", "논현"), ("daechi-dong", "대치"), ("sinsa-dong", "신사"),
                   ("apgujeong-dong", "압구정"), ("dogok-dong", "도곡"), ("gaepo-dong", "개포"),
                   ("ilwon-dong", "일원"), ("suseo-dong", "수서"), ("segok-dong", "세곡"),
                   ("jagok-dong", "자곡"), ("yulhyeon-dong", "율현")],
    "seocho-gu": [("seocho-dong", "서초"), ("banpo-dong", "반포"), ("bangbae-dong", "방배"),
                  ("jamwon-dong", "잠원"), ("yangjae-dong", "양재"), ("umyeon-dong", "우면"),
                  ("naegok-dong", "내곡"), ("yeomgok-dong", "염곡"), ("sinwon-dong", "신원")],
    "songpa-gu": [("jamsil-dong", "잠실"), ("sincheon-dong", "신천"), ("pungnap-dong", "풍납"),
                  ("songpa-dong", "송파"), ("seokchon-dong", "석촌"), ("samjeon-dong", "삼전"),
                  ("garak-dong", "가락"), ("munjeong-dong", "문정"), ("jangji-dong", "장지"),
                  ("bangi-dong", "방이"), ("ogeum-dong", "오금"), ("geoyeo-dong", "거여"),
                  ("macheon-dong", "마천")],
    "gangdong-gu": [("cheonho-dong", "천호"), ("seongnae-dong", "성내"), ("gil-dong", "길"),
                    ("dunchon-dong", "둔촌"), ("amsa-dong", "암사"), ("myeongil-dong", "명일"),
                    ("godeok-dong", "고덕"), ("sangil-dong", "상일"), ("gangil-dong", "강일")],
    "gangseo-gu": [("hwagok-dong", "화곡"), ("magok-dong", "마곡"), ("deungchon-dong", "등촌"),
                   ("yeomchang-dong", "염창"), ("gayang-dong", "가양"), ("balsan-dong", "발산"),
                   ("gonghang-dong", "공항"), ("banghwa-dong", "방화"), ("gaehwa-dong", "개화")],
    "yangcheon-gu": [("mok-dong", "목"), ("sinjeong-dong", "신정"), ("sinwol-dong", "신월")],
    "guro-gu": [("guro-dong", "구로"), ("sindorim-dong", "신도림"), ("garibong-dong", "가리봉"),
                ("gocheok-dong", "고척"), ("gaebong-dong", "개봉"), ("oryu-dong", "오류"),
                ("gung-dong", "궁"), ("onsu-dong", "온수"), ("cheonwang-dong", "천왕"),
                ("hang-dong", "항")],
    "geumcheon-gu": [("gasan-dong", "가산"), ("doksan-dong", "독산"), ("siheung-dong", "시흥")],
    "gwanak-gu": [("sillim-dong", "신림"), ("bongcheon-dong", "봉천"), ("namhyeon-dong", "남현")],
    "dongjak-gu": [("noryangjin-dong", "노량진"), ("sangdo-dong", "상도"), ("bon-dong", "본"),
                   ("heukseok-dong", "흑석"), ("dongjak-dong", "동작"), ("sadang-dong", "사당"),
                   ("daebang-dong", "대방"), ("sindaebang-dong", "신대방")],
    "yeongdeungpo-gu": [("yeouido-dong", "여의도"), ("yeongdeungpo-dong", "영등포"), ("dangsan-dong", "당산"),
                        ("mullae-dong", "문래"), ("yangpyeong-dong", "양평"), ("singil-dong", "신길"),
                        ("daerim-dong", "대림"), ("dorim-dong", "도림")],
    "gwangjin-gu": [("jayang-dong", "자양"), ("guui-dong", "구의"), ("hwayang-dong", "화양"),
                    ("gunja-dong", "군자"), ("gwangjang-dong", "광장"), ("junggok-dong", "중곡"),
                    ("neung-dong", "능")],
    "seongdong-gu": [("seongsu-dong", "성수"), ("haengdang-dong", "행당"), ("geumho-dong", "금호"),
                     ("oksu-dong", "옥수"), ("majang-dong", "마장"), ("wangsimni-dong", "왕십리"),
                     ("eungbong-dong", "응봉"), ("sageun-dong", "사근"), ("yongdap-dong", "용답"),
                     ("songjeong-dong", "송정")],
    "dongdaemun-gu": [("jeonnong-dong", "전농"), ("dapsimni-dong", "답십리"), ("imun-dong", "이문"),
                      ("jangan-dong", "장안"), ("hoegi-dong", "회기"), ("hwigyeong-dong", "휘경"),
                      ("cheongnyangni-dong", "청량리"), ("jegi-dong", "제기"), ("yongdu-dong", "용두"),
                      ("sinseol-dong", "신설")],
    "jungnang-gu": [("myeonmok-dong", "면목"), ("sangbong-dong", "상봉"), ("junghwa-dong", "중화"),
                    ("muk-dong", "묵"), ("mangu-dong", "망우"), ("sinnae-dong", "신내")],
    "seongbuk-gu": [("seongbuk-dong", "성북"), ("donam-dong", "돈암"), ("anam-dong", "안암"),
                    ("bomun-dong", "보문"), ("jeongneung-dong", "정릉"), ("gireum-dong", "길음"),
                    ("jongam-dong", "종암"), ("wolgok-dong", "월곡"), ("jangwi-dong", "장위"),
                    ("seokgwan-dong", "석관"), ("samseon-dong", "삼선")],
    "gangbuk-gu": [("mia-dong", "미아"), ("beon-dong", "번"), ("suyu-dong", "수유"), ("ui-dong", "우이")],
    ...
    "jongno-gu": [("hyehwa-dong", "혜화"), ("samcheong-dong", "삼청"), ("pyeongchang-dong", "평창"),
                  ("buam-dong", "부암"), ("sajik-dong", "사직"), ("cheongun-dong", "청운"),
                  ("myeongnyun-dong", "명륜"), ("changsin-dong", "창신"), ("sungin-dong", "숭인"),
                  ("ihwa-dong", "이화"), ("gahoe-dong", "가회"), ("muak-dong", "무악")],
    "jung-gu": [("myeong-dong", "명"), ("sindang-dong", "신당"), ("hwanghak-dong", "황학"),
                ("hoehyeon-dong", "회현"), ("euljiro-dong", "을지로"), ("chungmuro-dong", "충무로"),
                ("jangchung-dong", "장충"), ("gwanghui-dong", "광희"), ("dasan-dong", "다산")],
    "yongsan-gu": [("itaewon-dong", "이태원"), ("hannam-dong", "한남"), ("cheongpa-dong", "청파"),
                   ("hyochang-dong", "효창"), ("huam-dong", "후암"), ("ichon-dong", "이촌"),
                   ("bogwang-dong", "보광"), ("seobinggo-dong", "서빙고"), ("namyeong-dong", "남영"),
                   ("yongmun-dong", "용문"), ("wonhyoro-dong", "원효로"), ("yongsan-dong", "용산")],
    "mapo-gu": [("hapjeong-dong", "합정"), ("sangsu-dong", "상수"), ("gongdeok-dong", "공덕"),
                ("mangwon-dong", "망원"), ("seogyo-dong", "서교"), ("yeonnam-dong", "연남"),
                ("ahyeon-dong", "아현"), ("daeheung-dong", "대흥"), ("yeomri-dong", "염리"),
                ("seongsan-dong", "성산"), ("sangam-dong", "상암"), ("dohwa-dong", "도화"),
                ("yonggang-dong", "용강"), ("sinsu-dong", "신수")],
    "seodaemun-gu": [("sinchon-dong", "신촌"), ("yeonhui-dong", "연희"), ("hongje-dong", "홍제"),
                     ("hongeun-dong", "홍은"), ("bukahyeon-dong", "북아현"), ("namgajwa-dong", "남가좌"),
                     ("bukgajwa-dong", "북가좌"), ("chungjeongno-dong", "충정로"), ("daehyeon-dong", "대현"),
                     ("changcheon-dong", "창천"), ("bongwon-dong", "봉원")],
    "eunpyeong-gu": [("eungam-dong", "응암"), ("bulgwang-dong", "불광"), ("nokbeon-dong", "녹번"),
                     ("galhyeon-dong", "갈현"), ("gusan-dong", "구산"), ("daejo-dong", "대조"),
                     ("yeokchon-dong", "역촌"), ("sinsa-dong", "신사"), ("jeungsan-dong", "증산"),
                     ("susaek-dong", "수색"), ("jingwan-dong", "진관")],
}
